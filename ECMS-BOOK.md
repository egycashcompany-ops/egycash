...
| **Sprint 3.3 (Release v0.5.0)**                  | **Notifications Service** — in-app inbox + email, channel-adapter extension points (SMS/push/WhatsApp future), versioned templates, categories, quiet hours, priority levels, scheduling, idempotency, Socket.IO live push ([plan](docs/12-planning/sprint-3.3-plan.md), [reference](docs/02-architecture/notifications-service.md)) | humans learn what happened, on their channel     | 🔨 **Implementation complete — PR open, awaiting review**                                                                                                     |
