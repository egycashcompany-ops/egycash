...
| **Sprint 3.2 (Release v0.4.0)**                  | **Audit & Activity Service** — complete the 2.1 audit core to full ADR-012 spec: export, timelines, retention, security signals ([plan](docs/12-planning/sprint-3.2-plan.md), BD-007)                           | compliance answers are queries                   | ✅ **Plan approved 2026-07-09** · ⏳ implementation awaiting GO                                                                                               |
