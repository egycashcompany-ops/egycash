...
| **Sprint 3.3 (Release v0.5.0, proposed)**        | **Notifications Service** — in-app inbox + email, channel-adapter extension points (SMS/push future), templates, preferences, Socket.IO live push ([plan](docs/12-planning/sprint-3.3-plan.md))                                                                     | humans learn what happened, on their channel     | 📝 Plan in review                                                                                                                                             |
