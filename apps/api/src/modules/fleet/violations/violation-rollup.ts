...
export const assembleRollups = (
  ...
  for (const sum of sums) {
    byVehicle.set(keyOf(sum.vehicleId, sum.vehicleCode, sum.year), {
      ...
      outstandingVehicleCount: sum.outstandingVehicleCount,
      outstandingDriverCount: sum.outstandingDriverCount,
      outstandingTotalCount: sum.outstandingVehicleCount + sum.outstandingDriverCount,
