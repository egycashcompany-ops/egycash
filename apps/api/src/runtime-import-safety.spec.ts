// The api ships eight runtime entrypoints — server, worker, seed, seed:demo, atm:import,
// fleet:fix-crew-mission, import:workforce, reset:workforce — and all of them load
