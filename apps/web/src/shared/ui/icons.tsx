...
/** The revealed state's counterpart: the same eye, struck through. */
export const EyeOffIcon = (p: IconProps): JSX.Element => (
  <Base {...p}>
    <path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72 1.07A9.12 9.12 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94" />
