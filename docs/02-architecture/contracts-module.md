...
> Companion to the frozen design (`docs/12-planning/contracts-module-design.md`, Revision 2),
> which remains the single source of truth for the business rules and the recorded decisions
> (D1–D12, A1–A22, Q1–Q3). This page maps the design onto the codebase.
