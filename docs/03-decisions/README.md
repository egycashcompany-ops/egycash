...
now warn about but do not change. ADR-026 carries **two appendices** rather than spawning further
ADRs, because each refines a decision it already owns: SA-4 records that effective permissions are a
projection of the enforced answer and never a second authority, and SA-5/SA-6 record what "the last
