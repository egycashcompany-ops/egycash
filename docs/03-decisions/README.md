...
| [ADR-032](ADR-032-delegated-grants-per-site.md) | A manager hands out, per site, what they hold there — reach is recorded per permission key, and a delegated grant is a list of keys for one account in one site | Accepted |
