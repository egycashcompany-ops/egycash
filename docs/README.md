...
| Sprint 5.9 close-out — Release v0.21.0 recorded ([PR #50](https://github.com/egycashcompany-ops/egycash/pull/50)) | — | ✅ Completed & merged | EGYCASH | 2026-07-21 |
| Sprint 5.10 — HR/Recruitment: Pipeline flow & applicant lifecycle ([PR #51](https://github.com/egycashcompany-ops/egycash/pull/51) + [PR #52](https://github.com/egycashcompany-ops/egycash/pull/52)) | 0.22.0 | ✅ Reviewed & merged (derived auto-appear queues; optional committee; withdraw/restore from any stage with exact-stage resume; approach confirmed by EGYCASH across review rounds) | EGYCASH | 2026-07-21 |
| Sprint 5.10 retrospective — Recruitment Pipeline Flow & Lifecycle | — | ✅ Completed | EGYCASH | 2026-07-21 |
| Sprint 5.10 close-out — Release v0.22.0 recorded ([PR #53](https://github.com/egycashcompany-ops/egycash/pull/53)) | — | ✅ Completed & merged | EGYCASH | 2026-07-21 |
| Sprint 5.11 — HR Foundation Phase 1: Organization Structure ([PR #54](https://github.com/egycashcompany-ops/egycash/pull/54)) | 0.23.0 | ✅ Reviewed & merged (full org-structure admin — Company/Branches/Departments/Sections/Job Titles — on the existing `platform/organization` backend; enriched Job Titles; generic Unit\* admin; ADR-016 Talent-Pool invariant recorded) | EGYCASH | 2026-07-21 |
| Sprint 5.11 retrospective — Organization Structure (HR Foundation Phase 1) | — | ✅ Completed | EGYCASH | 2026-07-21 |
| Sprint 5.11 close-out — Release v0.23.0 recorded (this PR) | — | 🔍 Under review | — | 2026-07-21 |
| System Administration P1 — Users administration surface ([PR #158](https://github.com/egycashcompany-ops/egycash/pull/158)) | — | ✅ Reviewed & merged (UI over existing platform endpoints; no new backend, permission or contract) | EGYCASH | 2026-08-10 |
| System Administration P2 — Account creation, editing and the HR-owned employee link ([PR #159](https://github.com/egycashcompany-ops/egycash/pull/159)) | — | ✅ Reviewed & merged | EGYCASH | 2026-08-10 |
| System Administration P3 — Roles, permission registry and scoped assignments ([PR #160](https://github.com/egycashcompany-ops/egycash/pull/160)) | — | ✅ Reviewed & merged (escalation guards recorded as [ADR-026](03-decisions/ADR-026-role-administration-guards.md)) | EGYCASH | 2026-08-10 |
| System Administration P4 — Effective permissions projection ([PR #161](https://github.com/egycashcompany-ops/egycash/pull/161)) | — | ✅ Reviewed & merged (recorded as the SA-4 appendix to ADR-026; no new ADR) | EGYCASH | 2026-08-10 |
| System Administration — bulk selection in the permission matrix ([PR #162](https://github.com/egycashcompany-ops/egycash/pull/162)) | — | ✅ Reviewed & merged (frontend only; RBAC model unchanged) | EGYCASH | 2026-08-10 |
| System Administration P5 — Account & role retirement ([PR #163](https://github.com/egycashcompany-ops/egycash/pull/163)) | — | ✅ Reviewed & merged (includes a fix to the shipped P3 last-Super-Admin rule; one verification limitation recorded in the PR description) | EGYCASH | 2026-08-10 |
| System Administration P6 — UX & hardening ([PR #164](https://github.com/egycashcompany-ops/egycash/pull/164)) | — | ✅ Reviewed & merged (frontend only, 16 files; final merge commit `3286f6c`) | EGYCASH | 2026-08-10 |
| System Administration P7-A — Page registry in the contracts ([PR #166](https://github.com/egycashcompany-ops/egycash/pull/166)) | — | ✅ Reviewed & merged (46 pages, 172/202 permissions assigned, 30 deliberately unassigned; validated at startup and in CI) | EGYCASH | 2026-08-10 |
| System Administration P7-B — Module → Page → Permission matrix ([PR #167](https://github.com/egycashcompany-ops/egycash/pull/167)) | — | ✅ Reviewed & merged (frontend only; a module's rows are the concatenation of its pages' rows) | EGYCASH | 2026-08-10 |
| System Administration P7-C — Role duplication ([PR #168](https://github.com/egycashcompany-ops/egycash/pull/168)) | — | ✅ Reviewed & merged (a duplicate is a create; no duplicate endpoint) | EGYCASH | 2026-08-10 |
| System Administration P7-C follow-up — Duplicate made reachable ([PR #169](https://github.com/egycashcompany-ops/egycash/pull/169)) | — | ✅ Reviewed & merged (two UI-reachability defects reported from the running screen; final merge commit `f0463ab`) | EGYCASH | 2026-08-10 |
| System Administration P1–P7 retrospective ([docs](11-retrospectives/2026-08-system-administration-p1-p7.md)) | — | 🔍 Under review (this PR) | — | 2026-08-10 |
